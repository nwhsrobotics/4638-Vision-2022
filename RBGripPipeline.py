...
class RedBallGripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [104.6741194353037, 180.0]
        self.__hsv_threshold_saturation = [88.23797736183684, 255.0]
        self.__hsv_threshold_value = [67.57849127560476, 255.0]
